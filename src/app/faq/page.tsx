...
const faqs = [
  { q: "¿Qué es PreRescate PTY?", a: "Es un sistema panameño de identificación de emergencia que utiliza un sticker con chip NFC y código QR. Al pegarlo en tu casco o equipo, cualquier persona puede escanear el chip en caso de emergencia y ver tu información médica vital." },
  ...
  { q: "¿Qué pasa si pierdo mi casco o chip?", a: "Puedes suspender tu chip inmediatamente desde tu dashboard. El perfil público dejará de mostrarse al escanear. Puedes pedir un chip de reemplazo que se vinculará a tu misma cuenta." },
