                  ...
                  {order.corporateDeliveryStatus && (
                    <span
                      className={`px-3 py-1.5 rounded-xl border text-[10px] font-semibold ${
                        order.corporateDeliveryStatus === "delivered"
                          ...
                          : order.corporateDeliveryStatus === "in_transit"
                          ? "bg-blue-50 text-blue-700 border-blue-200"
                          : order.corporateDeliveryStatus === "ready_for_delivery"
                          ? "bg-teal-50 text-teal-700 border-teal-200"
                          : order.corporateDeliveryStatus === "on_hold"
                    ...
                    >
                      {order.corporateDeliveryStatus === "delivered"
                        ...
                        : order.corporateDeliveryStatus === "on_hold"
                        ? "⏸ En espera"
                        : order.corporateDeliveryStatus === "preparation_pending"
                        ? "⏳ Preparando"
                        : order.corporateDeliveryStatus}
                    </span>
                  )}
