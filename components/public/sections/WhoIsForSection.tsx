...
import { ArrowRight, Baby, Bike, Brain, Heart, PawPrint, Shield, Stethoscope, Users } from "lucide-react";
...
const audiences = [
  ...
  { icon: PawPrint, label: "Mascotas", desc: "Identificación para facilitar contacto y retorno seguro", glow: "green" as const },
];
        ...
        <div className="mb-10 grid items-end gap-6 sm:mb-14 sm:gap-8 lg:grid-cols-[1fr_.65fr]">
          ...
          >
            <p className="text-[15px] font-medium leading-6 text-slate-400 sm:text-lg sm:leading-7">
              PreRescue ID puede adaptarse a personas, familias, mascotas y situaciones de retorno seguro.
            </p>
