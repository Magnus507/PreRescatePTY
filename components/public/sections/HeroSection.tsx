...
export default function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden bg-[#fffdfb] text-slate-950 lg:min-h-[100svh]">
      ...
      <div className="mx-auto grid w-full max-w-[1500px] items-center gap-7 px-4 pb-8 pt-24 sm:px-6 sm:pb-12 sm:pt-28 lg:min-h-[100svh] lg:grid-cols-[.86fr_1.14fr] lg:gap-1 lg:px-10 lg:pb-16 lg:pt-32 xl:px-14">
        <div className="relative z-20 max-w-3xl">
          <div
            className="mb-5 inline-flex items-center gap-2 rounded-full border border-rose-200 bg-white/84 px-3.5 py-2 text-[9px] font-black uppercase tracking-[0.19em] text-[#b3131a] shadow-[0_12px_40px_-28px_rgba(218,26,33,.55)] sm:mb-7 sm:backdrop-blur-xl sm:text-[10px]"
          >
            <span className="relative flex h-2 w-2">
              <span className="absolute hidden h-full w-full animate-ping rounded-full bg-[#DA1A21] opacity-30 sm:inline-flex" />
        ...
        >
          <div className="relative w-full">
            ...
            <div className="md:hidden">
              <div className="relative mx-auto aspect-[4/3] w-full max-w-[520px] overflow-hidden rounded-[1.7rem] border border-slate-200 bg-white shadow-[0_22px_55px_-38px_rgba(15,23,42,.35)]">
                <Image
            ...
            <div className="absolute bottom-[8%] right-[2%] z-30 hidden w-[29%] md:block min-w-[128px] max-w-[205px] rotate-[5deg] overflow-hidden rounded-[1.35rem] border border-white/90 bg-white p-1.5 shadow-[0_24px_70px_-28px_rgba(15,23,42,.46)]">
