        ...
        <section className="bg-[#050914] py-20 md:py-32">
          <div className="mx-auto grid max-w-7xl gap-3 px-4 sm:gap-5 sm:px-6 lg:grid-cols-2 lg:px-8">
            ...
            <div className="rounded-[1.5rem] border border-white/[0.07] bg-white/[0.028] p-5 sm:rounded-[2rem] sm:p-9">
              ...
              <h2 className="mt-5 text-[1.7rem] font-black tracking-[-0.04em] text-slate-50 sm:mt-8 sm:text-3xl">Rescate continuo, administración anual</h2>
              <p className="mt-3 text-sm leading-6 text-slate-400 sm:mt-4 sm:text-base sm:leading-7">Cada unidad física elegible añade 12 meses de administración de perfiles y dispositivos. Si esa vigencia termina, puedes renovarla desde tu cuenta.</p>
              <p className="mt-4 text-xs leading-5 text-slate-600 sm:mt-5">El QR/NFC y la ficha pública de rescate continúan funcionando aunque venza la administración, salvo suspensión, revocación o reemplazo del identificador.</p>
            </div>
          </div>
        </section>
