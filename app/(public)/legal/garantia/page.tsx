    ...
    >
      <div className="space-y-6 text-[#A0AEC0]">
        ...
        <section>
          ...
          <p>
            El perfil médico puede transferirse a un chip nuevo después de verificar la identidad del titular y desactivar el chip anterior. El perfil digital no vence por tiempo.
          </p>
        </section>
