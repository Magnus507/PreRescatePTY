      ...
      <div className="max-w-[1600px] mx-auto flex h-screen">
        ...
        <aside className="hidden lg:flex w-80 flex-col bg-slate-50/80 border-r border-slate-200/60 p-6 z-10 transition-colors duration-1000">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100">
             <div className="p-4 rounded-3xl bg-slate-50 border border-slate-100 group hover:border-primary/20 transition-all cursor-pointer">
                <div className="flex items-center gap-3">
                   <div className="h-10 w-10 rounded-2xl bg-white border border-slate-200 flex items-center justify-center font-black text-primary text-sm shadow-sm">
