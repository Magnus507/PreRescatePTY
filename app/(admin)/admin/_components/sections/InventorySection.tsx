...
import { CheckCircle2, Copy, Factory, Loader2, Package, Plus, QrCode, RefreshCw, Search, Trash2, Link, Eye } from "lucide-react";
...
export const InventorySection: React.FC<InventorySectionProps> = ({
  ...
  const [activeSubTab, setActiveSubTab] = useState<"list" | "create" | "production">("list");
