        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300">
              El segundo factor es obligatorio para cuentas administrativas. La activación invalida tu sesión actual y exige iniciar sesión nuevamente con TOTP o un código de recuperación.
            </p>
          </div>
        </div>
