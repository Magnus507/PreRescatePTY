...
export const CreateCommercialOrderSchema = z.object({
  ...
  sourceType: z.string().trim().max(40, "sourceType es demasiado largo").optional().nullable(),
  ...
  internalReason: z.string().trim().max(2000, "internalReason es demasiado largo").optional().nullable(),
