...
export const ENV_CONTRACT = {
  ...
  DR_ALLOW_TARGET_OBJECTS: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
  DR_BACKUP_ID: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
  DR_BACKUP_PASSPHRASE: { scopes: ["script"], example: false, sensitive: true, requiredInProduction: false },
  DR_CONFIRM_ISOLATED_TARGET: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
  DR_PRODUCTION_PROJECT_REF: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
  DR_RESTORE_MODE: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
  DR_SENTINEL_ORDER_NUMBER: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
  DR_SOURCE_DB_URL: { scopes: ["script"], example: false, sensitive: true, requiredInProduction: false },
  DR_SOURCE_SUPABASE_SERVICE_ROLE_KEY: { scopes: ["script"], example: false, sensitive: true, requiredInProduction: false },
  DR_SOURCE_SUPABASE_URL: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
  DR_TARGET_DB_URL: { scopes: ["script"], example: false, sensitive: true, requiredInProduction: false },
  DR_TARGET_PROJECT_REF: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
  DR_TARGET_SUPABASE_SERVICE_ROLE_KEY: { scopes: ["script"], example: false, sensitive: true, requiredInProduction: false },
  DR_TARGET_SUPABASE_URL: { scopes: ["script"], example: false, sensitive: false, requiredInProduction: false },
...
const scriptOnlyShape = {
  ...
  DR_ALLOW_TARGET_OBJECTS: optionalString,
  DR_BACKUP_ID: optionalString,
  DR_BACKUP_PASSPHRASE: optionalString,
  DR_CONFIRM_ISOLATED_TARGET: optionalString,
  DR_PRODUCTION_PROJECT_REF: optionalString,
  DR_RESTORE_MODE: optionalString,
  DR_SENTINEL_ORDER_NUMBER: optionalString,
  DR_SOURCE_DB_URL: optionalString,
  DR_SOURCE_SUPABASE_SERVICE_ROLE_KEY: optionalString,
  DR_SOURCE_SUPABASE_URL: optionalUrl,
  DR_TARGET_DB_URL: optionalString,
  DR_TARGET_PROJECT_REF: optionalString,
  DR_TARGET_SUPABASE_SERVICE_ROLE_KEY: optionalString,
  DR_TARGET_SUPABASE_URL: optionalUrl,
